...
<div align="center">
    ...
    <div class="content-panel" align="center">
        ...
        <c:forEach items="${tags}" var="author" varStatus="loop">
            <form:form modelAttribute="tagData" action="tags/save.do" method="post" enctype="utf8" name="${loop.index}">
                ...
                <form:button formaction="tags/delete.do" class="medium delete" name="${loop.index}" hidden="true">
                    DELETE
                </form:button>
            </form:form>
        </c:forEach>
